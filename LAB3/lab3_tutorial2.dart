...
void main() {
  ...
  helloPersonAndPet('Madhav', 'Snow');
  // helloPersonAndPet();

  print(fullName('Madhav', 'Parmar'));
  print(fullName('Param', 'Trivedi', 'Expert'));
...
void anonymousFunctionsMiniExercise2() {
  const people = ['Madhav', 'Shivam', 'Yash'];
